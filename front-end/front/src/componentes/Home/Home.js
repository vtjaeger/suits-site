...
const Home = () => {
    return (
        <div className="div-home">
            ...
            <p>A série é ambientada em um prestigiado escritório de advocacia em Nova York e segue a vida pessoal e profissional de <Link to="/character/2">Harvey Specter</Link>, um advogado inteligente e bem-sucedido, e <Link to="/character/1">Mike Ross</Link>, um jovem prodígio com uma memória fotográfica, mas sem diploma de Direito.</p>
